    ...
    <div class="container">
      ...
      <div class="py-5">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h1 class="text-center display-3 text-primary">TAKEN JOBS</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      while($row = mysqli_fetch_assoc($consIdTable2)){   //Creates a loop to loop through results
        ...
        <td>" . $row['price'] . "</td>
        <td><a class='btn btn-primary' style='text-decoration:  none; ' href='makeComment.php?offId=".$row['offer_id']."' >Make Comment On Job</a></td>
        </tr>"; 
